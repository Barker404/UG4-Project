...
Which of these messages are actually shown to $v$ is determined by the social network's algorithm - which is what we wish to design. We define this as a function which given a user $v$ and a round $t$ returns a subset of their possible set at that time:
