...
\caption{Algorithm 5 ($f=0.2$)}
\end{subfigure}
\caption{Delivery rates as message count increases for various showing algorithms, showing the grid, graph, and diffusion distance measures. In every case diffusion distance does either worse than or similarly to the other two.}
