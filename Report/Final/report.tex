...
\path (-5.0,3.5) node (neighbour1) [draw, text width=8em, text centered, minimum height=2.5em, rounded corners] {Shared Set of $v_1$:\\ $S_{t-1}(v_{1})$};
\path (-0.7,3.5) node (neighbour2)[draw, text width=8em, text centered, minimum height=2.5em, rounded corners] {Shared Set of $v_2$:\\ $S_{t-1}(v_{2})$};
\path (2.15,3.3) node (dots)[above, text width=6em, text centered] {$\hdots$}; 
\path (5.0,3.5) node (neighbour3)[draw, text width=8em, text centered, minimum height=2.5em, rounded corners] {Shared Set of $v_n$:\\ $S_{t-1}(v_{n})$}; 

\path (0,-2.9) node (shared)[draw, text width=8em, text centered, minimum height=1em, rounded corners] {Shared Set:\\ $S_{t}(u)$}; 

\draw[-{Latex[scale=2.0]}] (shown.south) -- node[right] {User Model} (shared.north);
...
\draw[-{Latex[scale=2.0]}] (c) -- node[right] {Showing Algorithm} (shown.north);
...
\legend{200 Messages,400 Messages,600 Messages,800 Messages,1000 Messages,1200 Messages,1400 Messages}
\end{axis}
\end{tikzpicture}
...
\legend{200 Messages,400 Messages,600 Messages,800 Messages,1000 Messages}
\end{axis}
\end{tikzpicture}
...
\legend{$p_{further}=0.2$, $p_{further}=0.4$}
\end{axis}
\end{tikzpicture}
\caption{Algorithm 2}
...
\addplot[mark=diamond*, color=green!80!black] table [x=Message count, y=average delivered (percent), col sep=comma] {results/diffusion_distance/all_show_models/AnyCloser.csv};
\end{axis}
\end{tikzpicture}
\caption{Algorithm 1}
\end{subfigure}
...
\addplot[mark=diamond*, color=green!80!black] table [x=Message count, y=average delivered (percent), col sep=comma] {results/diffusion_distance/all_show_models/FurtherProb_20.csv};
\legend{$p_{further}=0.2$, $p_{further}=0.4$, $p_{further}=0.2$}
\end{axis}
\end{tikzpicture}
\caption{Algorithm 2}
...
\addplot[mark=diamond*, color=green!80!black] table [x=Message count, y=average delivered (percent), col sep=comma] {results/diffusion_distance/all_show_models/DistancePriority.csv};
\end{axis}
\end{tikzpicture}
\caption{Algorithm 4}
\end{subfigure}
...
\addplot[mark=diamond*, color=green!80!black] table [x=Message count, y=average delivered (percent), col sep=comma] {results/diffusion_distance/all_show_models/FractionalDistancePriority_05.csv};
\end{axis}
\end{tikzpicture}
\caption{Algorithm 5 ($f=0.05$)}
\end{subfigure}
...
\addplot[mark=diamond*, color=green!80!black] table [x=Message count, y=average delivered (percent), col sep=comma] {results/diffusion_distance/all_show_models/FractionalDistancePriority_20.csv};
